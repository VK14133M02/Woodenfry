...
const Home = () => {
  return (
    <Box width={"90%"} margin={"auto"}>
      ...
      <Box>
        <Text className="homePage_section_title">Shop What the Fry Deals</Text>
        <Box>
        ...
        <Box>
          <SimpleGrid columns={[1, 2, 3]} gap={"10px"}>
            ...
            <Box>
              ...
              />
              <Text className="mostWanted_category">6 Seater Dining Sets</Text>
              <Text className="mostWanted_description">
        ...
        <Box>
          <SimpleGrid columns={[1, 2, 3]} gap={"10px"}>
            <Box>
              ...
              />
              <Text className="mostWanted_category">Midnight Blues Sofas</Text>
              <Text className="mostWanted_description">
        ...
        <SimpleGrid columns={[1, 2, 3]} gap={3}>
          ...
          <Box>
            <Link to="#">
              <Image
                ...
                alt=""
              />
              <Text className="mostWanted_category">Barcelona Collection</Text>
              <Text className="mostWanted_description">
          ...
          <Box>
            <Link to="#">
              ...
              />
              <Text className="mostWanted_category">Stanfield Collection</Text>
              <Text className="mostWanted_description">
